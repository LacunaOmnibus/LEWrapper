...
namespace LE_Wrapper
{
    partial class LEWrapper
    {
        ...
        //private const Dictionary<string, int> requestID {"EmpireLogin", 101};
        //File file;
        ...
        public int GetRequestIDNumber(string r)/// every request sent will have a specific identifying number that will allow code to determine if the reply to a request is one that it has been waiting for
        {
            int reply = 0;
            return reply;
        }
        ...
        private async void WriteStringToLog(string toWrite)
        {
